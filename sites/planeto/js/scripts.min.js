...
$(function(){var e=$(".line").attr("value");$(this).css({width:e+"px"}),$(".menu ul li").click(function(){$(".menu ul li").removeClass("active"),$(this).addClass("active")}),$(".controls ul li").click(function(){$(".controls ul li").removeClass("f-active"),$(this).addClass("f-active")}),$(".hvc1").mouseenter(function(){$(".hv1").css({opacity:"1"})}),$(".hvc1").mouseleave(function(){$(".hv1").css({opacity:"0"})}),$(".hvc2").mouseenter(function(){$(".hv2").css({opacity:"1"})}),$(".hvc2").mouseleave(function(){$(".hv2").css({opacity:"0"})}),$(".hvc3").mouseenter(function(){$(".hv3").css({opacity:"1"})}),$(".hvc3").mouseleave(function(){$(".hv3").css({opacity:"0"})}),$(".hvc4").mouseenter(function(){$(".hv4").css({opacity:"1"})}),$(".hvc4").mouseleave(function(){$(".hv4").css({opacity:"0"})}),$(".hvc5").mouseenter(function(){$(".hv5").css({opacity:"1"})}),$(".hvc5").mouseleave(function(){$(".hv5").css({opacity:"0"})}),$(".hvc6").mouseenter(function(){$(".hv6").css({opacity:"1"})}),$(".hvc6").mouseleave(function(){$(".hv6").css({opacity:"0"})}),$(".click1").click(function(){$(".div2").removeClass("current"),$(".div3").removeClass("current"),$(".div1").addClass("current")}),$(".click2").click(function(){$(".div1").removeClass("current"),$(".div3").removeClass("current"),$(".div2").addClass("current")}),$(".click3").click(function(){$(".div2").removeClass("current"),$(".div1").removeClass("current"),$(".div3").addClass("current")}),$(".mixitup-container").mixItUp();var c=$.animateNumber.numberStepFactories.separator(" ");$(".s-item__number").each(function(){var e=$(this).data("count");$(this).animateNumber({number:e,easing:"easeInQuad","font-size":"60px",numberStep:c},5e3)});var s=$(".partners");s.owlCarousel({items:3,loop:!0,nav:!0,navText:""}),$(".next").click(function(){s.trigger("next.owl.carousel")}),$(".prev").click(function(){s.trigger("prev.owl.carousel",[300])})});