...
$(function(){$(".mixitup-container").mixItUp(),$("#my_menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],offCanvas:{position:"right"}});var e=$("#my_menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".works li").click(function(){$(".works li").removeClass("active"),$(this).addClass("active")}),$("ul li a").click(function(){return $("html, body").animate({scrollTop:$($(this).attr("href")).offset().top+"px"},{duration:500,easing:"swing"}),!1});var i=$(".head-slider");i.owlCarousel({loop:!0,items:1,nav:!0,navText:""}),$(".next").click(function(){i.trigger("next.owl.carousel")}),$(".prev").click(function(){i.trigger("prev.owl.carousel",[300])}),$(".features").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:500,easing:"swing",step:function(){$(".f-number").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var e=$.animateNumber.numberStepFactories.separator(" ");$(".f-number").each(function(){var i=$(this).data("count");$(this).animateNumber({number:i,easing:"easeInQuad","font-size":"40px",numberStep:e},1e3)})}),$(".workers").owlCarousel({items:1,dots:!0,smartSpeed:2e3}),$(".map-line .h3").click(function(){$(".locate").slideToggle("slow")})}),$(window).on("load",function(){$(".overlay-loader").delay(1e3).fadeOut("slow")});