...
$(document).ready(function(){$(".menu li").click(function(){$(".menu li").removeClass("active"),$(this).addClass("active")}),$("form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1}),$("#my_menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],offCanvas:{position:"right"}});var e=$("#my_menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),(new WOW).init(),$(".video").magnificPopup({type:"iframe"}),$(".g-item__popup").magnificPopup({type:"image"})});